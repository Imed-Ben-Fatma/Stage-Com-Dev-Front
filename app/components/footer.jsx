export function footer() {
    return (                                                
    <footer className= " w-full bg-gray-200 dark:bg-slate-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Grid */}
            <div className="grid grid-cols-12 gap-8 py-7 lg:grid-cols-8">
                <div className="mb-0 col-span-full lg:col-span-3 ">
                    ...
                    <p class="py-8  text-gray-500 lg:max-w-xs text-center lg:text-left">Bienvenue sur notre plateforme de location de logements, où propriétaires et locataires se rencontrent pour des expériences uniques et inoubliables.</p>
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-gray-900  dark:text-white font-medium mb-7">Get In Touch</h4>
                    <ul className="text-gray-600  transition-all duration-500">
                        <li className="mb-6">imad.benfatma98@gmail.com</li>
                        <li className="mb-6">+216 25 950 758</li>
                        <li >Moknine, Monastir, Tunisie.</li>
                    </ul>
                </div>
                {/* End Col */}
                <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                    <h4 class="text-lg text-gray-900 dark:text-white  font-medium mb-7">Products</h4>
                    <ul class="text-gray-600 transition-all duration-500  ">
                        <li className="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Home</a></li>
                        <li className="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">About</a></li>
                        <li className="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Pricing</a></li>
                        <li className="sm:mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Features</a></li>
                    </ul>
                </div>
            ...
            <div className="py-7 border-t border-gray-400">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/"> imad ben fatma</a> 2024, All rights reserved.</span>
