'use client'
import { fetchAllUsers ,updateOwnerForAdmin,searchUsers ,deleteUser} from "@/api/user"
                ...
                <table className="table-auto min-w-full rounded-lg w-full border-collapse bg-white dark:bg-gray-900 text-left text-sm text-gray-500 ">
                  <thead className="bg-gray-50 dark:bg-gray-950 " >
                    <tr >
                      ...
                      <th scope="col" className="py-5 text-left whitespace-nowrap text-sm leading-6 font-semibold capitalize">
                        Email
                      </th>
        ...
        <tr className=" border-2 border-gray-950 dark:text-slate-300  transition-all duration-500 hover:bg-gray-50 dark:hover:bg-gray-800 ">
            ...
            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium "> 
                ...
                {(edit)?(
                        ...
                        <input type="text" value={telephone} name="telephone" onChange={handleInputChange}
                            className="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-1 px-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-28" 
                        >
                        </input>
                    ):(
            ...
            {(edit)?(
                    ...
                    <div className="flex p-5  items-center gap-0.5" >
                        ...
                        <Link href={`./reservations/user/${user.id}`} className=" rounded-full  transition-all duration-500 hover:bg-gray-400 flex item-center">
